...
/** @type {string} */
const CACHE_VERSION = '1743857679|723674881';
/** @type {string} */
const CACHE_PREFIX = 'ld57-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'ld57.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["ld57.html","ld57.js","ld57.offline.html","ld57.icon.png","ld57.apple-touch-icon.png","ld57.audio.worklet.js","ld57.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["ld57.wasm","ld57.pck"];
